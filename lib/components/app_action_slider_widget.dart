...
class ActionSlider extends StatefulWidget {
  ...
  final VoidCallback? successStateCallback;
  ...
  const ActionSlider.custom({
    ...
    this.actionThresholdType = ThresholdType.release,
    this.stateChangeCallback,
    this.successStateCallback,
  ...
  ActionSlider.standard({
    ...
    this.actionThresholdType = ThresholdType.release,
    this.stateChangeCallback,
    this.direction = TextDirection.ltr, this.successStateCallback,
        ...
        toggleWidth = toggleWidth ?? height - borderWidth * 2,
        toggleMargin = EdgeInsets.zero /*EdgeInsets.all(borderWidth)*/,
              ...
              child: Align(
                ...
                child: ClipRect(
                  child: Align(
                    ...
                    child: Padding(
                      padding: EdgeInsets
                          .zero /*EdgeInsetsDirectional.only(
...
class _ActionSliderState extends State<ActionSlider>
  ...
  StreamSubscription<RefreshEvent>? _resetStream;

  @override
  void initState() {
    super.initState();
    _resetStream = Utils.eventBus.on<RefreshEvent>().listen((event) {
      if (event.refreshType == RefreshType.SLIDER) {
        _movementController.animateTo(0);
        reset();
      }
    });
    ...
    if (widget.position != null) {
      _movementController.animateTo(widget.position ?? 0,
  ...
  void reset() {
    setState(() {
      ...
      if (widget.actionThresholdType == ThresholdType.release &&
              ...
              child: SizedBox.fromSize(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.zero /* widget.toggleMargin*/,
                        ...
                        Positioned.directional(
                          ...
                          child: GestureDetector(
                            ...
                            onHorizontalDragEnd: (details) => setState(() {
                              this.actionSliderState = actionSliderState;
                              if (_state.position == 1) {
                                widget.successStateCallback?.call();
                                return;
                              }
                              if (_state.state != SlidingState.dragged) return;
                              _changeState(
